  ...
  return (
    <div className='App bg1'>
      <nav class="navbar navbar-dark bg-dark">
        <div class="container">
          <a class="navbar-brand">Fernando Elias González Ortega-----31701459------Desarrollo Web</a>
        </div>
      </nav>
      ...
      <footer class="navbar navbar-dark bg-dark fixed-bottom">
        <div class="container">
          <p class="navbar-brand">Fernando Elias González Ortega-----31701459------Desarrollo Web</p>
        </div>
      </footer>
    </div>
  );
